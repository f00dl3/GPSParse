...
public class GPSParse {
	...
	public static void main(String args[]) {
		...
		if (legacyFlag.equals("yes")) {
			...
			gpsQuery = "UPDATE Core.Fitness SET "+activityType+"="+activityType+"+"+trackedDistance+" , "+activityDataField+"='"+fullGPSjson+"', "+geoJSONField+"='"+geoJSONtrace+"', TrackedTime="+trackedTime+", TrackedDist="+trackedDistance;
